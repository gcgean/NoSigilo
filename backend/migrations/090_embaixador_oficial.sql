...
ALTER TABLE users ADD COLUMN embaixador_oficial_em TEXT;
ALTER TABLE users ADD COLUMN embaixador_oficial_nota TEXT;
ALTER TABLE users ADD COLUMN embaixador_oficial_oculto INTEGER NOT NULL DEFAULT 0;
ALTER TABLE users ADD COLUMN embaixador_trial_anterior TEXT;
