...
ALTER TABLE experiences ADD COLUMN IF NOT EXISTS categoria TEXT;
ALTER TABLE experiences ADD COLUMN IF NOT EXISTS status TEXT NOT NULL DEFAULT 'publicado';
ALTER TABLE experiences ADD COLUMN IF NOT EXISTS revisao_motivo TEXT;
