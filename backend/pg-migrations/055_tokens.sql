...
ALTER TABLE users ADD COLUMN IF NOT EXISTS token_points INTEGER DEFAULT 0;
ALTER TABLE users ADD COLUMN IF NOT EXISTS token_points_total INTEGER DEFAULT 0;
ALTER TABLE users ADD COLUMN IF NOT EXISTS token_free_days INTEGER DEFAULT 0;
